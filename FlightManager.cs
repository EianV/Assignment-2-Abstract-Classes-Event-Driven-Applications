       ...
       */
        ...
        */
        ...
        public static List<Flight> findFlights(string from, string to, string weekday)
        {
            ...
            foreach (Flight flight in flights)
            {
                if (flight.To.Contains(to) && flight.From.Contains(from) && flight.Weekday.Contains(weekday))
                {
                    found.Add(flight);
                }
                else if (flight.To.Contains(to) && flight.From.Contains(from) && weekday.Equals(WEEKDAY_ANY))
                {
                    found.Add(flight);
                }
            }   
